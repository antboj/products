...
class Laptop extends Computer{
    ...
    // Set properties
    public function set($device_name,$OS,$processor,$ram_memory,$screen_size=null,$touch_screen=null){
    ...
    public function insert(){
        ...
        $st = $pdo->prepare("INSERT INTO device_properties (OS, processor, ram_memory, screen_size, touch_screen, devices_id, device_type_id) VALUES (:OS, :processor, :ram_memory, :screen_size, :touch_screen, :lid, :type)");
        $st->execute([':OS'=>$this->OS, ':processor'=>$this->processor, ':ram_memory'=>$this->ram_memory, ':screen_size'=>$this->screen_size, ':touch_screen'=>$this->touch_screen, ':lid'=>$lid, ':type'=>$this->type]);
    ...
    public function update($id){
        ...
        $st = $pdo->prepare("UPDATE device_properties SET OS=:OS, processor=:processor, ram_memory=:ram_memory, screen_size=:screen_size, touch_screen=:touch_screen WHERE devices_id=:id");
        $st->execute([':OS'=>$this->OS, ':processor'=>$this->processor, ':ram_memory'=>$this->ram_memory, ':screen_size'=>$this->screen_size, ':touch_screen'=>$this->touch_screen, ':id'=>$id]);
    }
